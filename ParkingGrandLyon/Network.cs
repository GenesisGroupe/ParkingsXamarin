...
namespace ParkingGrandLyon
{
	public class Network
	{
		...
		static string directionsUrl = "https://maps.googleapis.com/maps/api/directions/json?origin={0},{1}&destination={2},{3}&mode=DRIVING&key=AIzaSyDt-2m8MNOGOVI5yRcBhEDLYj4YZpUMje0";
